 ...
 */
final class Version20220417121705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ADD referent_source VARCHAR(255) DEFAULT NULL, CHANGE fichier fichier VARCHAR(255) NOT NULL');
